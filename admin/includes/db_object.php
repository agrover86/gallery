...
class Db_object{
  ...
  private function has_the_attribute($the_attribute){
    ...
    public function save(){
      return isset($this->{static::$db_id}) ? $this->update() : $this->create();
    }
    ...
    public function create(){
       ...
       if($database->query($sql)){
         $this->{static::$db_id} = $database->the_insert_id();
         return true;
       } else {
         return false;
       }
    ...
    public function update(){
      ...
      $sql.= " WHERE ".static::$db_id."=".$database->escape_string($this->{static::$db_id});
